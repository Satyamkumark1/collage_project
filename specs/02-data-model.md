...
**key_points, question_sets, questions, flashcards, quizzes, quiz_attempts, quiz_answers**
[deferred] — see [10-study-features.md](10-study-features.md) for full column lists when built.
...
`DocumentChunkRepository`, `AiJobRepository`, `AiCallRepository`, `SummaryRepository`.
